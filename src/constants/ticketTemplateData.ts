...
export const TICKET_TEMPLATE_DATA: TicketTemplate[] = [
  ...
  },
  {
    id: "guide-onboarding",
    name: "작업 가이드/온보딩",
    purpose: "반복 작업 문서화 또는 신규 인력 온보딩",
    type: "문서",
    color: "#8b5cf6",
    icon: "BookOpen",
    fields: [
      { key: "title", label: "가이드 주제", required: true, type: "text", placeholder: "가이드 주제를 입력하세요" },
      {
        key: "description",
        label: "가이드 요청 배경 및 목적",
        required: true,
        type: "textarea",
        placeholder: "가이드가 필요한 배경과 목적을 설명하세요",
      },
      {
        key: "documentScope",
        label: "작성 요청 항목 또는 문서 범위",
        required: true,
        type: "textarea",
        placeholder: "문서에 포함되어야 할 항목이나 범위를 입력하세요",
      },
      {
        key: "referenceLinks",
        label: "참고 자료 또는 예시 링크",
        required: false,
        type: "textarea",
